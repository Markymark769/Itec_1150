...
def main():
    # Grand (as in overall) input of number of years to ask for monthly rainfall for.
    # mipo inputs(): For mipo style this is one of the inputs.  We are calling it inputs_grand().
