...
## TODO: put while loop on inputs
# TODO: put while loop on get pos_int
...
def input_prompt(): #TODO: create while loop for validation
    ...
    small = get_pos_int(input('Please enter a small number, 0 or higher: '))  # the same as number 9
    # print('Now, enter a larger number that you want to count up to: ')
    large = get_pos_int(input('Now, enter a larger number that you want to count up to: '))  # and check_large_number()
