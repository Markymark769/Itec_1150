...
this code was developed by M. Bock 6/11/2019
The program tracks coffee stand sales by drink,
...
total_cups = 0  # you are starting out with 0 so you can have the correct digits.
total_sales = 0.0
for type in range(drink_types):  # note we are putting a for loop inside another for loop
